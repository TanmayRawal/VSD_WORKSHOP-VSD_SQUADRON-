...
Navigate to the assessment directory and list all available Verilog design and testbench files:
...
```verilog
/* Generated by Yosys 0.7 (Sky130 RTL Design & Synthesis) */
...
> - The OR gate is implemented as **NAND(INV(a), INV(b))** — this is because NAND gates are preferred over NOR in CMOS (stacked PMOS transistors have poor mobility, making NOR gates slower and larger)
...
- **[VSD Squadron Program](https://www.vlsisystemdesign.com/)** — For providing the assessment platform, curated lab environment, and assessment framework
